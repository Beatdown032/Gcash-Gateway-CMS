<?php
/**
 * Plugin Name: GCash Gateway WooCommerce
 * Plugin URI: https://github.com/Beatdown032/Gcash-Gateway-CMS/
 * Description: Offline payment method for Globe GCash.
 * Author: Chris Luke
 * Author URI: https://lucaschriston.com/
 * Version: 1.0.1
 * Text Domain: cms-gateway-gcash
 * Domain Path: /i18n/languages/
 *
 * Copyright: (c) 2022 Chris Luke and CMS
 *
 ...
 * @category  Admin
 * @copyright Copyright (c) 2022 Chris Luke and CMS
